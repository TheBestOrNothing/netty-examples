...
public class HttpsServer{
	...
	public void run() throws Exception{
        ...
        SelfSignedCertificate clientssc = new SelfSignedCertificate("EC", "client");
        SelfSignedCertificate serverssc = new SelfSignedCertificate("EC", "server");
        //SelfSignedCertificate thirdssc = new SelfSignedCertificate("RSA", "third");

        ArrayList<String> enabledSuites = new ArrayList<String>();
        enabledSuites.add("TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384");
        enabledSuites.add("TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256");
