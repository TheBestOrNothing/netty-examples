 ...
 * this class in production. It is purely for testing purposes, and thus it is
 * very insecure. It even uses an insecure pseudo-random generator for faster
 * generation internally.
 * </p>
 * <p>
 * An X.509 certificate file and a EC/RSA private key file are generated in a
...
public final class SelfSignedCertificate {
     ...
     * synchronization
     */
    private static final Date DEFAULT_NOT_BEFORE = new Date(SystemPropertyUtil
            .getLong("io.netty.selfSignedCertificate.defaultNotBefore", System.currentTimeMillis() - 86400000L * 365));
    /** The maximum possible value in X.509 specification: 9999-12-31 23:59:59 */
    private static final Date DEFAULT_NOT_AFTER = new Date(
            SystemPropertyUtil.getLong("io.netty.selfSignedCertificate.defaultNotAfter", 253402300799000L));
     ...
     * </p>
     */
    public SelfSignedCertificate(String algorithm, String fileName) throws CertificateException {
        this("localhost", new SecureRandom(), DEFAULT_NOT_BEFORE, DEFAULT_NOT_AFTER, algorithm, DEFAULT_KEY_LENGTH_BITS, fileName);
    ...
    public SelfSignedCertificate(String fqdn, SecureRandom random, Date notBefore, Date notAfter, 
            String algorithm, int bits, String fileName) throws CertificateException {
        ...
        try {
            ...
            if (algorithm.equalsIgnoreCase("EC")){
                //Currently Bitcoin and Ethereum use secp256k1 with the ECDSA algorithm.
                //But the handshake complete successfully when change to the secp256r1.
            ...
            // Should not reach here because every Java implementation must have RSA and EC
            // key pair generator.
            throw new Error(e);
        ...
        try {
            ...
            paths = BouncyCastleSelfSignedCertGenerator.generate(fqdn, keypair, random, notBefore, notAfter, algorithm, fileName);
        } catch (Throwable t2) {
    ...
    /**
     * Returns the generated EC private key.
     */
    ...
    /**
     * Returns the generated EC public key.
     */
    ...
    static String[] newSelfSignedCertificate(String fqdn, PrivateKey key, X509Certificate cert, String fileName)
        ...
        File keyFile = new File(fileName + "rsa.key");
        ...
        File certFile = new File(fileName + "rsa.cert");
